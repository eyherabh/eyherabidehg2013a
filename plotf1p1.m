function hfig=plotf1p1(example)
    ...
    % decoders for all possible values of the stimulus probabiltiies, and 
    % constructs panels like Fig 1G and Fig 1H.
    %
    ...
    % EXAMPLE:
    %
    % ex.pr1r2ds(1,:,:)=[0,1/5;4/5,0];
    % ex.pr1r2ds(2,:,:)=[1/2,0;0,1/2];
    % plotf1p1(ex);
    %
    % VERSION CONTROL
    % 
    ...
    for ip1=1:99,
        ...
        % Sets stimulus probabilities
        ps=[ip1/100,1-ip1/100];
        ...
        for itype=1:3,
            di(itype,ip1)=100*infoloss(ditype{itype},psr1r2)/info;
        end
    end
